...
// why here and not placed in HTML? Because HTML loads faster than upper DOMContentLoaded, making the stars and halo flash across the whole screen before they get the hidden attribute in this function. When they flash, they're stretched to 100% width (from having no width, so it uses the 100% from the viewbox).
